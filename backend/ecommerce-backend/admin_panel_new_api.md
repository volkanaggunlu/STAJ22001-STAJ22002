# 🔧 ElektroTech Admin Panel - EKSİK API ENDPOINT'LER
...
```json
{
  ...
  "status": "active",
  "featured": false,
  "seoTitle": "Arduino UNO R4 - ElektroTech",
...
### 11. Son Siparişler (Dashboard için)
```
...
### 12. Kargo Takip Numarası Ekleme
```
...
```json
{
  ...
  "seoTitle": "ESP32 Ürünleri - ElektroTech",
...
### 15. Kategori Güncelleme
```
PUT /api/admin/categories/:id
```

### 16. Kategori Silme (Soft Delete)
```
