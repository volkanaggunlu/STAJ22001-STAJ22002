		...
		<main className="container mx-auto px-4 py-10 max-w-3xl">
			...
			<section className="space-y-6 text-gray-800 leading-relaxed">
				<div>
					...
					<p>
						Bu Kullanım Koşulları, {siteName} ("Site") üzerinden sunulan hizmetlerden yararlanan tüm ziyaretçi ve
						kullanıcılar için geçerlidir. Siteyi kullanarak, bu şartları okuduğunuzu ve kabul ettiğinizi beyan edersiniz.
					</p>
				</div>
				...
				<div>
					...
					<p>
						{siteName}, elektronik ve teknoloji ürünleri alanında hizmet vermektedir. Site içeriği ve hizmetleri önceden
				...
				<div>
					...
					<p>
						Site üzerindeki tüm görseller, metinler, logolar ve yazılımlar {siteName}’a veya lisans sahiplerine aittir.
						İzinsiz kopyalanamaz veya çoğaltılamaz.
					</p>
				</div>
				...
				<div>
					...
					<p>
						{siteName}, kullanım koşullarını dilediği zaman değiştirme hakkını saklı tutar.
					</p>
				</div>
			</section>
		</main>
