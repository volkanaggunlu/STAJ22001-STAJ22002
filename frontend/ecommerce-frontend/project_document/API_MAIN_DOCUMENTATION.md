# 🚀 Açık Atölye E-Ticaret API Dokümantasyonu
...
const bankAccounts = [
  {
    ...
    accountHolder: "Açık Atölye Ticaret A.Ş."
  },
  {
    bankName: "İş Bankası",
...
```env
# Database
MONGODB_URI=mongodb://localhost:27017/Açık Atölye
MONGODB_TEST_URI=mongodb://localhost:27017/Açık Atölye_test
...
BASITKARGO_USERNAME=example-username
BASITKARGO_PASSWORD=example-password
...
Bu dokümantasyon Açık Atölye e-ticaret API'sinin tam yapısını ve gereksinimlerini detaylandırır. Her dosya maksimum 200 satır olacak şekilde modüler olarak tasarlanmıştır ve profesyonel kod yazım tekniklerini kullanır. 